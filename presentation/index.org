...
** RNN's are a powerful tool for text generation
...
** Experiment idea
   ...
   - Genrate a collection of docs per author through sampling
...
*** Caveat
    ...
    #+END_NOTES
    #+attr_reveal: :frag (roll-in)
    Assumes algorithmic definition of style
    #+attr_reveal: :frag (roll-in)
    #+BEGIN_QUOTE
...
*** Difficulties
    ...
    - Unequal training and testing sizes per author for the attributor (important in AA)
...
#+reveal: split
Validation perplexity@@html:: <span class="fragment">4.015 (± 0.183)</span>@@
...
- Why does NGLM outperforms RNNLM in both setups (alpha_bar,omega), (omega,alpha_bar)?
...
*** Doc-level PCA
#+reveal: split
NGLM (150 most-freq ngrams doc-representation)
#+BEGIN_HTML
<img src="./img/nglm_pca.svg">
#+END_HTML

#+reveal: split
RNNLM (150 most-freq ngrams doc-representation)
#+BEGIN_HTML
...
Mean-normalized Jaccard-similarity on author ngrams

#+reveal: split
Character-level

#+BEGIN_HTML
<img src="./img/jaccard_mean_char.svg">
#+END_HTML
